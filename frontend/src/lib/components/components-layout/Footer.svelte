<div class="border-base-300/80 bg-base-100 border-t border-dashed px-4 py-4 md:px-8 xl:px-12 2xl:px-20">
    <div class="flex items-center justify-between px-0">
        <p>
            Built and designed with care by
            <a class="text-primary" href="https://withden.dev/" target="_blank"> Denish </a>
        </p>
        <a
            aria-label="Buy now"
