	...
	>
		<div class="bg-base-200/30 rounded-t-box border-base-200 border-b ps-4 pe-2 pt-3">
			<div class="flex items-center justify-between">
				...
				<button class="btn btn-xs btn-circle btn-ghost" aria-label="Close" on:click={closeMenu}>
				...
				<div class="-ms-2 mt-2 -mb-px flex items-center justify-between">
					<div role="tablist" class="tabs tabs-sm tabs-border">
						...
						<div
							...
							on:click={() => (step = 4)}
							class="tab gap-2 px-3"
							class:tab-active={step === 4}
							class:font-medium={step === 4}
						>
							<span>@mention</span>
						</div>
					</div>
		...
		<div class="hover:bg-base-200/20 flex items-start gap-3 p-4 transition-all">
			...
			<div class="grow">
				...
				>
					<p class="text-sm">
						Forecast Report <span class="text-base-content/60 text-xs">(12 MB)</span>
					</p>
